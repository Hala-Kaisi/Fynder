...
class chatList_itemStartup extends StatefulWidget{
  final Investor user;
  final Startup chatUser;

  const chatList_itemStartup({required this.user, required this.chatUser});

  @override
  _chatList_item createState() => _chatList_item();
}

class _chatList_item extends State<chatList_itemStartup> {

  late Investor _user;
  late Startup _chatUser;
